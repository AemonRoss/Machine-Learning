...
def convert_dataset_no_one_hot_nofillna(df, isEval=False):
...
dfx=convert_dataset_no_one_hot_nofillna(df)
dfx=fill_mean(dfx)
dfe=convert_dataset_no_one_hot_nofillna(eval_set, True)
dfe=fill_mean(dfe)
dfx.info()
dfx.head()
